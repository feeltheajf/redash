...
from .helpers import array_from_string, parse_boolean
...
TRUSTED_URLS = [
    urlparse(u)
    for u in array_from_string(os.environ.get("REDASH_TRUSTED_URLS", ""))
]
...
JWT_LOGIN_ENABLED = parse_boolean(
    os.environ.get("REDASH_JWT_LOGIN_ENABLED", "false")
)
JWT_AUTH_ISSUER = os.environ.get("REDASH_JWT_AUTH_ISSUER", "")
JWT_AUTH_PUBLIC_CERTS_URL = os.environ.get(
